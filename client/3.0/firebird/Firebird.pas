...
{ $DEFINE USEFBEXCEPTION}
	...
	dscPtr = ^dsc;
	isc_stmt_handlePtr = ^isc_stmt_handle;
	isc_tr_handlePtr = ^isc_tr_handle;
	...
	IBatch_addBlobPtr = procedure(this: IBatch; status: IStatus; length: Cardinal; inBuffer: Pointer; blobId: TISC_QUADPtr; parLength: Cardinal; par: BytePtr); cdecl;
	...
	IBatch_registerBlobPtr = procedure(this: IBatch; status: IStatus; existingBlob: TISC_QUADPtr; blobId: TISC_QUADPtr); cdecl;
	...
	IAttachment_createBlobPtr = function(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob; cdecl;
	IAttachment_openBlobPtr = function(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob; cdecl;
	IAttachment_getSlicePtr = function(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr): Integer; cdecl;
	IAttachment_putSlicePtr = procedure(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr); cdecl;
	...
	IUtil_loadBlobPtr = procedure(this: IUtil; status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean); cdecl;
	IUtil_dumpBlobPtr = procedure(this: IUtil; status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean); cdecl;
	...
	IUtil_getTransactionByHandlePtr = function(this: IUtil; status: IStatus; hndlPtr: isc_tr_handlePtr): ITransaction; cdecl;
	IUtil_getStatementByHandlePtr = function(this: IUtil; status: IStatus; hndlPtr: isc_stmt_handlePtr): IStatement; cdecl;
	...
	IReplicatedTransaction_deleteRecordPtr = function(this: IReplicatedTransaction; name: PAnsiChar; &record: IReplicatedRecord): Boolean; cdecl;
	...
	IBatch = class(IReferenceCounted)
		...
		procedure addBlob(status: IStatus; length: Cardinal; inBuffer: Pointer; blobId: TISC_QUADPtr; parLength: Cardinal; par: BytePtr);
		...
		procedure registerBlob(status: IStatus; existingBlob: TISC_QUADPtr; blobId: TISC_QUADPtr);
	...
	IBatchImpl = class(IBatch)
		...
		procedure addBlob(status: IStatus; length: Cardinal; inBuffer: Pointer; blobId: TISC_QUADPtr; parLength: Cardinal; par: BytePtr); virtual; abstract;
		...
		procedure registerBlob(status: IStatus; existingBlob: TISC_QUADPtr; blobId: TISC_QUADPtr); virtual; abstract;
	...
	IBatchCompletionState = class(IDisposable)
		...
		const NO_MORE_ERRORS = Cardinal(-1);
	...
	IAttachment = class(IReferenceCounted)
		...
		function createBlob(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob;
		function openBlob(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob;
		function getSlice(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr): Integer;
		procedure putSlice(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr);
	...
	IAttachmentImpl = class(IAttachment)
		...
		function createBlob(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob; virtual; abstract;
		function openBlob(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob; virtual; abstract;
		function getSlice(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr): Integer; virtual; abstract;
		procedure putSlice(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr); virtual; abstract;
	...
	IUtil = class(IVersioned)
		...
		procedure loadBlob(status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean);
		procedure dumpBlob(status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean);
		...
		function getTransactionByHandle(status: IStatus; hndlPtr: isc_tr_handlePtr): ITransaction;
		function getStatementByHandle(status: IStatus; hndlPtr: isc_stmt_handlePtr): IStatement;
	...
	IUtilImpl = class(IUtil)
		...
		procedure loadBlob(status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean); virtual; abstract;
		procedure dumpBlob(status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean); virtual; abstract;
		...
		function getTransactionByHandle(status: IStatus; hndlPtr: isc_tr_handlePtr): ITransaction; virtual; abstract;
		function getStatementByHandle(status: IStatus; hndlPtr: isc_stmt_handlePtr): IStatement; virtual; abstract;
	...
	IReplicatedTransaction = class(IDisposable)
		...
		function insertRecord(name: PAnsiChar; &record: IReplicatedRecord): Boolean;
		function updateRecord(name: PAnsiChar; orgRecord: IReplicatedRecord; newRecord: IReplicatedRecord): Boolean;
		function deleteRecord(name: PAnsiChar; &record: IReplicatedRecord): Boolean;
	...
	IReplicatedTransactionImpl = class(IReplicatedTransaction)
		...
		function insertRecord(name: PAnsiChar; &record: IReplicatedRecord): Boolean; virtual; abstract;
		function updateRecord(name: PAnsiChar; orgRecord: IReplicatedRecord; newRecord: IReplicatedRecord): Boolean; virtual; abstract;
		function deleteRecord(name: PAnsiChar; &record: IReplicatedRecord): Boolean; virtual; abstract;
...
procedure IBatch.addBlob(status: IStatus; length: Cardinal; inBuffer: Pointer; blobId: TISC_QUADPtr; parLength: Cardinal; par: BytePtr);
begin
...
procedure IBatch.registerBlob(status: IStatus; existingBlob: TISC_QUADPtr; blobId: TISC_QUADPtr);
begin
...
function IAttachment.createBlob(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob;
begin
	Result := AttachmentVTable(vTable).createBlob(Self, status, transaction, id, bpbLength, bpb);
	{$IFDEF USEFBEXCEPTION}FbException.checkException(status);{$ENDIF}
end;

function IAttachment.openBlob(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob;
begin
	Result := AttachmentVTable(vTable).openBlob(Self, status, transaction, id, bpbLength, bpb);
	{$IFDEF USEFBEXCEPTION}FbException.checkException(status);{$ENDIF}
end;

function IAttachment.getSlice(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr): Integer;
begin
	Result := AttachmentVTable(vTable).getSlice(Self, status, transaction, id, sdlLength, sdl, paramLength, param, sliceLength, slice);
	{$IFDEF USEFBEXCEPTION}FbException.checkException(status);{$ENDIF}
end;

procedure IAttachment.putSlice(status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr);
begin
...
procedure IUtil.loadBlob(status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean);
begin
	UtilVTable(vTable).loadBlob(Self, status, blobId, att, tra, file_, txt);
	{$IFDEF USEFBEXCEPTION}FbException.checkException(status);{$ENDIF}
end;

procedure IUtil.dumpBlob(status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean);
begin
...
function IUtil.getTransactionByHandle(status: IStatus; hndlPtr: isc_tr_handlePtr): ITransaction;
begin
	Result := UtilVTable(vTable).getTransactionByHandle(Self, status, hndlPtr);
	{$IFDEF USEFBEXCEPTION}FbException.checkException(status);{$ENDIF}
end;

function IUtil.getStatementByHandle(status: IStatus; hndlPtr: isc_stmt_handlePtr): IStatement;
begin
...
function IReplicatedTransaction.insertRecord(name: PAnsiChar; &record: IReplicatedRecord): Boolean;
begin
	Result := ReplicatedTransactionVTable(vTable).insertRecord(Self, name, &record);
end;
...
function IReplicatedTransaction.deleteRecord(name: PAnsiChar; &record: IReplicatedRecord): Boolean;
begin
	Result := ReplicatedTransactionVTable(vTable).deleteRecord(Self, name, &record);
end;
...
procedure IBatchImpl_addBlobDispatcher(this: IBatch; status: IStatus; length: Cardinal; inBuffer: Pointer; blobId: TISC_QUADPtr; parLength: Cardinal; par: BytePtr); cdecl;
begin
	try
...
procedure IBatchImpl_registerBlobDispatcher(this: IBatch; status: IStatus; existingBlob: TISC_QUADPtr; blobId: TISC_QUADPtr); cdecl;
begin
	try
...
function IAttachmentImpl_createBlobDispatcher(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob; cdecl;
begin
	try
...
function IAttachmentImpl_openBlobDispatcher(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; bpbLength: Cardinal; bpb: BytePtr): IBlob; cdecl;
begin
	try
...
function IAttachmentImpl_getSliceDispatcher(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr): Integer; cdecl;
begin
	try
...
procedure IAttachmentImpl_putSliceDispatcher(this: IAttachment; status: IStatus; transaction: ITransaction; id: TISC_QUADPtr; sdlLength: Cardinal; sdl: BytePtr; paramLength: Cardinal; param: BytePtr; sliceLength: Integer; slice: BytePtr); cdecl;
begin
	try
...
procedure IUtilImpl_loadBlobDispatcher(this: IUtil; status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean); cdecl;
begin
	try
...
procedure IUtilImpl_dumpBlobDispatcher(this: IUtil; status: IStatus; blobId: TISC_QUADPtr; att: IAttachment; tra: ITransaction; file_: PAnsiChar; txt: Boolean); cdecl;
begin
	try
...
function IUtilImpl_getTransactionByHandleDispatcher(this: IUtil; status: IStatus; hndlPtr: isc_tr_handlePtr): ITransaction; cdecl;
begin
	try
...
function IUtilImpl_getStatementByHandleDispatcher(this: IUtil; status: IStatus; hndlPtr: isc_stmt_handlePtr): IStatement; cdecl;
begin
	try
...
function IReplicatedTransactionImpl_insertRecordDispatcher(this: IReplicatedTransaction; name: PAnsiChar; &record: IReplicatedRecord): Boolean; cdecl;
begin
	try
		Result := IReplicatedTransactionImpl(this).insertRecord(name, &record);
	except
		on e: Exception do FbException.catchException(nil, e);
	end
end;
...
function IReplicatedTransactionImpl_deleteRecordDispatcher(this: IReplicatedTransaction; name: PAnsiChar; &record: IReplicatedRecord): Boolean; cdecl;
begin
	try
		Result := IReplicatedTransactionImpl(this).deleteRecord(name, &record);
	except
		on e: Exception do FbException.catchException(nil, e);
	end
end;
...
initialization
	...
	IReplicatedTransactionImpl_vTable.version := 12;
